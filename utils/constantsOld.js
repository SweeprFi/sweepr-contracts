...
const rpcLinks = {
  ...
  420: `https://opt-goerli.g.alchemy.com/v2/${process.env.ALCHEMY_KEY}`,
  8453: `https://base-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_KEY}`,
  84531: `https://base-goerli.g.alchemy.com/v2/${process.env.ALCHEMY_KEY}`,
}
...
const apiKeys = {
  ...
  10: process.env.OPTIMISTIC_API_KEY,
  420: process.env.OPTIMISTIC_API_KEY,
...
const wallets = {
  owner: {
    ...
    10: '0x7Adc86401f246B87177CEbBEC189dE075b75Af3A', // Optimism
    420: '0x7Adc86401f246B87177CEbBEC189dE075b75Af3A', // Optimism Goerli
    8453: '0x7Adc86401f246B87177CEbBEC189dE075b75Af3A', // Base
    84531: '0x7Adc86401f246B87177CEbBEC189dE075b75Af3A', // Base Goerli
  },
  borrower: {
    ...
    10: '0x7Adc86401f246B87177CEbBEC189dE075b75Af3A',
    420: '0x93aE1efd2E78028351C080FA0fbBBeF97Ec42EAD',
  },
  wallet: {
    1: '0x93aE1efd2E78028351C080FA0fbBBeF97Ec42EAD',
    5: '0x93aE1efd2E78028351C080FA0fbBBeF97Ec42EAD',
  ...
  treasury: {
    ...
    421613: '0x7c9131d7E2bEdb29dA39503DD8Cf809739f047B3',
    10: '0x7c9131d7E2bEdb29dA39503DD8Cf809739f047B3',
    8453: '0x7c9131d7E2bEdb29dA39503DD8Cf809739f047B3'
  },
  usdc_holder: {
  ...
  multisig: { // Gnosis safe wallet
    ...
    10: '0xE0585bDaee364deAd2683c5Aa1520B87F1d2FBAD',
    8453: '0x8610F105F3d0a0479d9c9D85C13b352f6c8EefeE'
  },
}
...
const tokens = {
  sweep: {
    ...
    5: '0x6C68a114c406dA77c3Ce1Ad1Cf09B420E37087b8',
  ...
  usdc: { // USDC native
    ...
    5: '0x07865c6E87B9F70255377e024ace6630C1Eaa37F',//'0x65aFADD39029741B3b8f0756952C74678c9cEC93',
  ...
  aave_usdc: {
    ...
    5: '0x8Be59D90A7Dc679C5cE5a7963cD1082dAB499918',
  ...
  usdPlus: {
    ...
    10: '0x73cb180bf0521828d8849bc8CF2B920918e23032',
  },
  ets: {
    1: '',
    5: '',
...
const libraries = {
  liquidity_helper: {
    ...
    10: '0xaD490d3899A47482E31AF50DdCc5Db31C0eE9eB0',
    421613: '0x524ff4dc8A0a66fDaC7F71d9d2babcE1d297006E',
    8453: '0xC5f0DE0D8f48E12CcDE9f1902dE15A975b59768d',
  },
  uniswap_oracle: {
    1: '',
  ...
  usdPlus_exchanger: {
    ...
    10: '0xe80772Eaf6e2E18B651F160Bc9158b2A5caFCA65',
  },
  ets_exchanger: {
...
const chainlinkOracle = {
  ...
  sequencer_feed: {
    ...
    10: '0x371EAD81c9102C9BF4874A9075FFFf170F2Ee389',
    420: '0x4C4814aa04433e0FB31310379a4D6946D5e1D353',
...
const uniswap = {
  factory: {
    ...
    421613: '0x1F98431c8aD98523631AE4a59f267346ea31F984',
  ...
  router: {
    ...
    421613: '0xE592427A0AEce92De3Edee1F18E0157C05861564',
  ...
  universal_router: {
    ...
    10: '0x4648a43B2C14Da09FdF82B161150d3F634f40491',
    420: '0x4648a43B2C14Da09FdF82B161150d3F634f40491',
  ...
  positions_manager: {
    ...
    421613: '0xC36442b4a4522E871399CD717aBDD847Ab11FE88',
    10: '0xC36442b4a4522E871399CD717aBDD847Ab11FE88',
    420: '0xC36442b4a4522E871399CD717aBDD847Ab11FE88',
    8453: '0x03a520b32C04BF3bEEf7BEb72E919cf822Ed34f1',
  },
  pool: {
    1: '0xfCAF342A7CbE3ea38622337F8d0Df029dc68bFF5',
    5: '0xf704129f06E8f414e92d212B60e3E8528B5E2554',
    ...
    10: '0x8A0F60a4544c712Becdf9d6c4A920F4b756186ec', // SWEEP / USDC native
    8453: '', // SWEEP / USDC native
  },
  quoter: {
...
const protocol = {
  ...
  balancer: {
    ...
    5: '0x20955880B9d3ecC0df0681DDCD59665455e5f8af',
    42161: '0x82f23E915985de7Db7C9463E4d898ccf2ab2fCeF',
    421613: '0xd4e0D68789694a2221b77C6823e914619310Ae18',
    10: '0xa884970F06Dda7BedD86829E14BeCa2c8fEd5220',
    8453: '0xa884970F06Dda7BedD86829E14BeCa2c8fEd5220',
  },
  distributor: {
  ...
  uniswap_amm: {
    ...
    5: '0x1f1Da159Db4dAB54bfDcD94783e3B5234C2e8e11',
    ...
    10: '0x7685fc882c91936BF94974916cC410028F73C957', // SWEEP / USDC native
    421613: '0x14C53b4C05EC802c71CbFd8039e056573E902AFb',
    8453: '0xa5Dd492674f8C68C89b403BDFd0e794db42f2b92',
  },
  ...
  omnichain_proposal_executor: {
    ...
    10: '0xE7b247DBbb1bFdC8E223e78F9585ACF93Df297f5',
    8453: '0xE7b247DBbb1bFdC8E223e78F9585ACF93Df297f5',
  },
  timelock: {
...
const assets = {
  ...
  uniswap: {
    ...
    10: '0xC5f0DE0D8f48E12CcDE9f1902dE15A975b59768d',
  },
  weth: {
  ...
  usd_plus: {
    ...
    10: '0x709d075147a10495e5c3bBF3dfc0c138F34C6E72',
  },
  dai_dsr: {
